...
# adjust resolution image (default 25448, 25332 -> 1000, 1000)
resized_image = cv2.resize(equ, (1000, 1000))  # shape, shape
plt.subplot(1, 2, 2)
plt.title("Resized Image default 25448, 25332 -> 1000, 1000")
